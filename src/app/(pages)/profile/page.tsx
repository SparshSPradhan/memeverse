...
//   const [uploadedMemes, setUploadedMemes] = useState<string[]>([]); // User's uploaded memes
//   const [likedMemes, setLikedMemes] = useState<string[]>([]); // User's liked memes
...
//     const savedUploads = JSON.parse(localStorage.getItem("user_uploadedMemes") || "[]");
//     const savedLikes = JSON.parse(localStorage.getItem("user_likedMemes") || "[]");
...
//     loadMemes(); // Load memes initially

//     // Listen for storage changes (real-time updates)
//     const handleStorageChange = (event: StorageEvent) => {
//       if (event.key === "userMemes") {
//         loadMemes();
//       }
//     };
